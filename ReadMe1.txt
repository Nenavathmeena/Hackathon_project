...
->pageObjects : In this file, the BasePage,DoctordetailsPage and ListdetailsPage classes are defined.

->stepDefinitions : In this file, doctorDetails, Hooks and Storeprint classes are defined.
...
->Testdata  : In this folder, there are  config.properties, extent.properties and surgeries.xlsx are defined.
